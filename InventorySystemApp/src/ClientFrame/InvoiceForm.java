...
public class InvoiceForm extends javax.swing.JFrame {
    ...
    public InvoiceForm(Invoice invoice) {
        ...
        priceField.setText(""+this.invoice.getTotalPrice());
        String products = this.invoice.getProductsName().toString().replace("[", "").replace("]", "");
         productsField.setText(products);
        DateField.setText(this.invoice.getOrderDate().toString());
        nameFiled.setText(this.invoice.getClientName());
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(productsField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new ConfirmBuying(this,true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               ...
               list.add("product");
              new InvoiceForm(new Invoice("karim",12,new Date(),list)).setVisible(true);
            }
        });
    }
